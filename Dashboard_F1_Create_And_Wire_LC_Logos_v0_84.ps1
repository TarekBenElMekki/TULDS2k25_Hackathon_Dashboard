...
$backupDir = Join-Path $root ".backup-lc-logos-v0_84-$stamp"
...
$helperMarker = "/* === LC LOGO RESOLVER v0_84 === */"
$helper = @'
/* === LC LOGO RESOLVER v0_84 === */
...
$cssStart = "/* === LC LOGOS LEFT v0_84 START === */"
$cssEnd = "/* === LC LOGOS LEFT v0_84 END === */"
$cssPatch = @"
$cssStart
.lc-logo-wrap {
  --lcLogoColor: #e10600;
